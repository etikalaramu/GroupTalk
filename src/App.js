...
function ResponsiveDrawer(props) {
  ...
  const drawer = (
    <div style={{boxShadow: '8px 1px 10px -6px rgba(0,0,0,0.44)',backgroundColor:'#f7f7f7',
height:'100%'}}>
      ...
      <List>
        {['GroupTalk Web', 'Settings', 'Quicktalk History', 'User Guide','Request Callback','Contact Us','FAQs'].map((text, index) => (
